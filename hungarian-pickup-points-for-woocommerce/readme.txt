...
* Pénztár blokk telefonszám validálás javítás
...
* Product Bundles súlysázmítás javítás
* GLS csomagkövetés hibajavítás(dátum)
* Kvikk feladási cím választó csak Kvikk szolgáltató esetén látszódik

4.2.1
* Térképen a szolgáltató választónál az első kattintás az adott szolgáltatót választja csak ki, a többit elrejti
* Kvikk Sameday javítás
* Kvikk feladási cím választás címkegenerálás előtt
* Express One csomagkövetés javítás
* Külföldi geolokáció javítás
...
3.6.5
* Kvikk PHP Warning javítás

3.6.4
* Kvikk referenciaszám javítás
* Kvikk A5-ös címke pozíció javítás
* Kompatibilitás megjelölése legújabb Woo verzióval
...
3.6
* Kvikk több küldeményes csomag és kiegészítő szolgáltatások támogatása
* Trans-Sped ZERO javítások
* MPL javítás EU-n kívüli szállításnál

3.5.9.4
* Utánvét díj beállítás javítás: az új fizetési mód beállítások képernyőre nem lehet egyedi űrlapot beszúrni, így átkerült a beállítás a szállítás menü utánvét almenüjébe

3.5.9.3
* Pénztár blokk javítások

3.5.9.2
* WooCommerce 9.9.3 kompatibilitás javítás

3.5.9.1
* vp_woo_pont_target_order_status_after_label_generated, vp_woo_pont_custom_label_mpdf_config és vp_woo_pont_custom_label_mpdf_template filter
...
3.5.7.2
* Foxpost nyomtatás megoldás: Imagick-el átkonvertálja PNG-re és így dolgozik vele

3.5.7.1
* 3.5.7-ben lévő Foxpost-os változás visszacsinálása, mert sajnos a megoldás nem volt GPL licensz kompatiblis. A címkegenerálást sikerült megoldani, de a csoportos nyomtatás nem működik Foxpost esetében sajnos, letölteni lehet csak a címkét. 
...
* %-os utánvét díj opcionálisan szállítási költséget is beleszámolja
* Referenciaszámnak lehet egyedi mezőt megadni a beállításokban
* Webshippy javítás Sequential Order Numbers bővítménnyel
* Csomagkövetés e-mail javítás
* DPD csomagkövetés javítás

3.5.5.1
* GLS keresés javítása térképen(ékezetes karakterek)
* Kvikk bugfixek
* Csomagpiac karakterlimit filter(DPD-nél max 35 lehet)

3.5.5
* Kvikk DPD Csomagpont és AlzaBox támogatás

3.5.4.4
* Térkép keresés hibajavítás

3.5.4.3
* Kvikk DPD javítás

3.5.4.2
* Utánvét díj javítás shortcode pénztárnál

3.5.4.1
* Fekvő A4 nyomtatás javítása

3.5.4
* Pénztár blokk fejlesztések
* DPD árazás javítás
* Pénztár blokk utánvét díj javítás

3.5.3
* Többcsomagos címke esetén a csoportos nyomtatás működik
* Pénztár blokk utánvét díj javítás
* GLS INS szolgáltatás
* WC 9.7 kompatibilitás megjelölés

3.5.2.1
* Kvikk GLS és DPD támogatás
* Foxpost-al generált Packeta címke javítása A4-es etiketten
* Csomagpiac címkeméret beállítás
